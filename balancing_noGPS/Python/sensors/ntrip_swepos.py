...
# ntripclient = NtripClient(user="***REMOVED***:***REMOVED***",caster="192.71.190.141",port=80,mountpoint="MSM_GNSS",verbose=True)
...
# if ntrip_correction:
    ...
    # ntripclient = NtripClient(user="***REMOVED***:***REMOVED***", caster="192.71.190.141", port=80, mountpoint="MSM_GNSS",lat=lat_ini,lon=lon_ini,verbose=True)
# else:
