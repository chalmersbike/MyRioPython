...
import numpy as np
from param import initial_speed, controller_frequency, gainScheduling_enable
...
gps_sampling_time = 1.0 / gps_dataUpdateRate
...
ntrip_username = "***REMOVED***"        # Username to connect to NTRIP caster
ntrip_password = "***REMOVED***"               # Password to connect to NTRIP caster
...
########################################################################################################################
# Path Tracking
max_rollref = 4 # [deg] maximum roll reference to be set by path tracking controller
# Controller gains can be speed dependant if they are arrays with multiple values
# If they contain a single value they are not speed dependant
