...
cdef class PID(object):
    """
    PID Controller adapted from https://github.com/ivmech/ivPID
    """
    cdef public double Kp, Ki, Kd, PTerm, ITerm, DTerm, windup_guard
    cdef double sample_time, current_time, last_time, Reference, last_error, last_output, int_error, output,
    def __init__(self, float P=0.2, float I=0.0, float D=0.0):
    ...
    cpdef float update(self, float feedback_value):
        ...
        """
        cdef float error, delta_time, delta_error
        error = self.Reference - feedback_value

        self.current_time = time.time()
        delta_time = self.current_time - self.last_time
        delta_error = error - self.last_error
        # print(self.current_time, -self.last_time, delta_time)
    ...
    cpdef setKp(self, float proportional_gain):
        """Determines how aggressively the PID reacts to the current error with setting Proportional Gain"""
        self.Kp = proportional_gain

    cpdef setKi(self, float integral_gain):
        """Determines how aggressively the PID reacts to the current error with setting Integral Gain"""
        self.Ki = integral_gain

    cpdef setKd(self, float derivative_gain):
        """Determines how aggressively the PID reacts to the current error with setting Derivative Gain"""
        self.Kd = derivative_gain

    cpdef setWindup(self, float windup):
    ...
    cpdef setSampleTime(self, float sample_time):
    ...
    cpdef setReference(self, float reference):
