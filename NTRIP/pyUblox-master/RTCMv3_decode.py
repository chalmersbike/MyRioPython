...
def RTCM_converter_thread(server, port, username, password, mountpoint, rtcm_callback = None):
    ...
    nt = subprocess.Popen(["./ntrip.py",server,port,username,password,mountpoint],stdout=subprocess.PIPE)
...
if __name__ == '__main__':
    ...
    RTCM_converter_thread('192.71.190.141', "80", "ChalmersE2RTK", "885511", 'MSM_GNSS', _printer)
