...
pid_steeringangle_P = 30.0
pid_steeringangle_I = 0.0
pid_steeringangle_D = 0
pid_steeringangle_sample_time = 1.0 / CONTROLLER_FREQUENCY



b = 1.15        # distance between rear and front wheel
h = 0.543       # height center of mass
c = 0.04        # trail front wheel
a = 0.6687      # distance center of mass from center of back wheel
